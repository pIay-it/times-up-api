...
| **team***                                          | String                               | Expected team to play in this position in the queue. Set only if `options.players.areTeam` is `true`.                                                                                                                                                                       |
...
| **scores***                                        | [Game Summary Score](#game-summary-score-structure)[]    | Final scores for each team or player. Only set if game status is set to `over`. (_See: [Structures - Game Summary Score](#game-summary-score-structure)_)                                         |
